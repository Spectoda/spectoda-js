...
export interface SpectodaClass {
  ...
  emitTimestamp(event_label: SpectodaTypes.Label, event_value: SpectodaTypes.Timestamp, device_ids?: SpectodaTypes.IDs): Promise<any>;
  emitColor(event_label: SpectodaTypes.Label, event_value: SpectodaTypes.Color, device_ids?: SpectodaTypes.IDs): Promise<any>;
  emitPercentage(event_label: SpectodaTypes.Label, event_value: SpectodaTypes.Percentage, device_ids?: SpectodaTypes.IDs): Promise<any>;
  emitLabel(event_label: SpectodaTypes.Label, event_value: SpectodaTypes.Label, device_ids?: SpectodaTypes.IDs): Promise<any>;
  ...
  syncTimeline(timestamp?: SpectodaTypes.Timestamp | null, paused?: boolean | null, date?: SpectodaTypes.Date | null): Promise<any>;
