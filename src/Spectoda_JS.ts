...
// ? These are types relevant for App Layer. This types should be moved to a separate file.
...
export namespace SpectodaTypes {
  ...
  // TODO create Value pair to every possible JSEvent type
  ...
  export type TnglJSEvent = "tngl_update";

  export type JsEvent = ConnectionJSEvent | WebsocketJSEvent | LegacyPreviewJSEvent | RuntimeJSEvent | PeerJSEvent | OtaJSEvent | TnglJSEvent;
